                                    ...
                                    {assetQueue.map(asset => (
                                        <div key={asset.id} className="flex items-center justify-between bg-slate-50 border border-slate-200 rounded-lg px-3 py-2">
                                            <div className="flex items-center space-x-2 text-sm text-slate-700">
                                                ...
                                                <span>{asset.name || asset.text || 'Recurso'}</span>
                                            </div>
                                    ...
                                    {activity.assets?.length > 0 && (
                                        <div className="flex flex-wrap gap-2">
                                            {activity.assets.map(asset => (
                                                <span key={asset.id} className={clsx('px-3 py-1 rounded-full text-xs font-medium border', asset.type === 'image' && 'border-teal-200 text-teal-700 bg-teal-50', asset.type === 'audio' && 'border-amber-200 text-amber-700 bg-amber-50', asset.type === 'label' && 'border-slate-200 text-slate-700 bg-slate-50')}>
                                                    {asset.type === 'image' && '📷 Imagen'}
